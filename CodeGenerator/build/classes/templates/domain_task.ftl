			...
			<tbody>
				<s:iterator value="models" id="model">
					<tr>
						...
						<td>
							<a href="<s:url action='${domain.name}_approveAction'><s:param name='id' value='#model.id'/><s:param name='taskId' value='#model.bizWorkflow.taskId'/></s:url>">批准</a>
							<a href="<s:url action='${domain.name}_rejectAction'><s:param name='id' value='#model.id'/><s:param name='taskId' value='#model.bizWorkflow.taskId'/></s:url>">驳回</a>
						</td>
					</tr>
				</s:iterator>
			</tbody>
